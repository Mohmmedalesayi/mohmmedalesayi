...
<!-- إحصائيات عامة (تأكد من تحديث اسم المستخدم) -->
...
<!-- إحصائيات Streak (النشاط اليومي المتواصل) -->
### ⏱ Streak Stats
<!-- تأكد من أن 'user=' يطابق اسم المستخدم الخاص بك -->
...
<!-- الرسم البياني للنشاط (Activity Graph) -->
### 📈 Activity Graph
